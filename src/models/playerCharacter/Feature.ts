...
export interface FeatureBaseData {
    pcId: string;
    name: string;
    description: string;
...
export interface Feature {
    id: string,
    data: FeatureBaseData & { 
        displayIndex: number;  // index of feature among other features with the same pcId, for display sorting purposes     
    }
}
